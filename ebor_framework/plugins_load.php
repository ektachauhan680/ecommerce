...
function my_theme_register_required_plugins() {
	 ...
	 */
	$config = array(
		'domain'       		=> 'slowave',         	// Text domain - likely want to be the same as your theme.
		...
		'strings'      		=> array(
			'page_title'                       			=> __( 'Install Required Plugins', 'slowave' ),
			'menu_title'                       			=> __( 'Install Plugins', 'slowave' ),
			'installing'                       			=> __( 'Installing Plugin: %s', 'slowave' ), // %1$s = plugin name
			'oops'                             			=> __( 'Something went wrong with the plugin API.', 'slowave' ),
			...
			'return'                           			=> __( 'Return to Required Plugins Installer', 'slowave' ),
			'plugin_activated'                 			=> __( 'Plugin activated successfully.', 'slowave' ),
			'complete' 									=> __( 'All plugins installed and activated successfully. %s', 'slowave' ), // %1$s = dashboard link
