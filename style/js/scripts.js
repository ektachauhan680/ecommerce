...
jQuery(document).ready(function() {
  ...
  //               console.log(thisHref);
        ...
        // added a fix for menu current class 
            jQuery('.navbar ul a').click(function(){
              //console.log('here');
                jQuery('.navbar ul a[href^="#"]').each(function() {
    ...
    // adding the smooth scrolling to pricing and package button on homepage
    // jQuery('#pricingg-btnn').on('click', function(event){
    ...
    // adding the local scroll to section 
    if( jQuery('body').hasClass('page-template-page_one_pager-php') ){    
